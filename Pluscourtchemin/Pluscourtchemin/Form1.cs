...
namespace Pluscourtchemin
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            for (int j = 1; j < solution.Count; j++)
            {
                Node2 N2 = (Node2)solution[j];
            ...
            while (ligne != null)
            {
                ...
                matrice[N, N2] = val;
                matrice[N2, N] = val;
                listBoxgraphe.Items.Add(Convert.ToString(N)
                   + "--->" + Convert.ToString(N2)
                   + "   : " + Convert.ToString(matrice[N, N2]));
